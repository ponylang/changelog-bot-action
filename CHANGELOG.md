...
- Reduce retry delay when PR isn't immediately available ([PR #92](https://github.com/ponylang/changelog-bot-action/pull/92))
...
- Improve resilience to GitHub API failures ([PR #85](https://github.com/ponylang/changelog-bot-action/pull/85))
- Fix crash on unexpected GitHub error response format ([PR #86](https://github.com/ponylang/changelog-bot-action/pull/86))
- Retry on connection errors for all GitHub API calls ([PR #87](https://github.com/ponylang/changelog-bot-action/pull/87))

## [0.3.9] - 2026-05-28

### Fixed

- Fix intermittent crash when looking up the PR for a commit ([PR #83](https://github.com/ponylang/changelog-bot-action/pull/83))

## [0.3.8] - 2026-03-24

### Fixed

- Retry when GitHub API doesn't immediately return PR for a commit ([PR #76](https://github.com/ponylang/changelog-bot-action/pull/76))

## [0.3.7] - 2025-03-08

### Fixed

- Fix "it no longer works" bug ([PR #71](https://github.com/ponylang/release-notes-bot-action/pull/71))
